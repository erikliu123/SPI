...
int UdSetDomain(u_int8_t domain)
{
    int errorCode = UD_SUCCESS;
...
int UdSetSecurityWpa(unsigned type, u_int8_t *key, unsigned key_len)
{
    int errorCode = UD_SUCCESS;
    int i;
...
static int ValidateWpsPin(u_int8_t *wps_pin)
{
    int pin = 0;
    int accum = 0;
    int i;
...
int UdSetSecurityWps(unsigned type, u_int8_t *pin, unsigned pin_len)
{
    int errorCode = UD_SUCCESS;
...
int UdSetNetworkType(u_int8_t networkType)
{
...
static int ValidateChannelList(u_int8_t *p_channelList, u_int8_t numChannels)
{
    int errorCode = UD_SUCCESS;
    int i;
...
int UdSetChannelList(u_int8_t *p_channelList, u_int8_t numChannels)
{
    int errorCode = UD_SUCCESS;
...
static int ValidateSsid(u_int8_t *p_ssid, u_int8_t ssidLength)
{
    int errorCode = UD_SUCCESS;
...
int UdSetSsid(u_int8_t *p_ssid, u_int8_t ssidLength)
{
    int errorCode;
...
int UdSetBssid(u_int8_t *p_bssid)
{
...
int UdSetReconnectMode(unsigned retry_count, int reconnect_on_deauth, int reconnect_on_loss)
{
    int errorCode = UD_SUCCESS;
...
static int ValidateChannelsWithDomain(u_int8_t *p_channelList,
...
static int ValidateWpsChannelList(const u_int8_t domain,
    const u_int8_t *p_channelList, const u_int8_t numChannels)
{
    int errorCode = UD_SUCCESS;
    int channelBitMask = 0;
    int compareMask;
    int i;
...
static int CheckInfrastructureConnect()
{
    int errorCode = UD_SUCCESS;
...
int UdSetHwMulticastFilter(u_int8_t multicastFilterId, u_int8_t *p_multicastAddress)
{
